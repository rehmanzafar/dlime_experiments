...
# np.save("data/synthetic/X_train_bc_sc.npy", train)
# np.save("data/synthetic/X_test_bc_sc.npy", test)
# np.save("data/synthetic/y_train_bc_sc.npy", labels_train)
# np.save("data/synthetic/y_test_bc_sc.npy", labels_test)
...
# print(f"Fidelity DLIME-KM Overall = {avg_dlime_fid}")
